...
def make_model():
  ...
  logits = tf.keras.layers.Dense(256, name='dense_1_start_end')(sequence_output)
  logits = tf.keras.layers.Dense(128, name='dense_2_start_end')(logits)
  logits = tf.keras.layers.Dense(2, name='dense_3_start_end')(logits)
...
def model_fn_builder(bert_config, init_checkpoint, learning_rate,
  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
    ...
    if mode == tf.estimator.ModeKeys.TRAIN:
      ...
      # train_op = optimization.create_optimizer(learning_rate, num_train_steps,
      #                                         num_warmup_steps)
